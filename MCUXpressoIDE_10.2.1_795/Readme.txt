...
* Fixed issue in New Project Wizard when switching between a board
...
* SDK-based projects can now be converted to have ‘local SDK part
  support’, allowing improved project sharing (such projects no
...
* Fixed an issue seen when importing a single SDK example, in which
...
* MCUXpresso Config Tools now integrated within the IDE, for use
