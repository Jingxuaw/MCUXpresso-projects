...
src/%.o: ../src/%.cpp
	...
	arm-none-eabi-c++ -std=c++11 -D__NEWLIB__ -DDEBUG -D__CODE_RED -DCORE_M3 -D__USE_LPCOPEN -DCPP_USE_HEAP -D__LPC15XX__ -I"D:\MCUXpressoIDE_10.2.1_795\lpc_board_nxp_lpcxpresso_1549\inc" -I"D:\MCUXpressoIDE_10.2.1_795\lpc_chip_15xx\inc" -I"D:\MCUXpressoIDE_10.2.1_795\FreeRTOS\inc" -I"D:\MCUXpressoIDE_10.2.1_795\FreeRTOS\src\include" -I"D:\MCUXpressoIDE_10.2.1_795\FreeRTOS\src\portable\GCC\ARM_CM3" -O0 -fno-common -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fno-rtti -fno-exceptions -mcpu=cortex-m3 -mthumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
